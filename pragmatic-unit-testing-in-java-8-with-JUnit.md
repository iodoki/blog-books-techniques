 ...
 * FI[R]ST - **Repeatable** test is one that produces the same results each time you run it, and are accomplished afeer isolating them form the in the external environment which is not in your direct control. 
