...
**FIRST** Principles of Good Testing. **FIRST** - reminds the characteristics of quality tests. Write the unit tests before you write the corresponding code, descipline known as TDD
